...
- Dealing with emojis is also straightforward. Basically nothing needs to be done in particular. All modern terminals handles it automatically I guess. Or is it the typeface? Or maybe fonts? dunno.
